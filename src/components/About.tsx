          ...
          <div className="md:w-2/3">
            <h3 className="text-3xl font-bold mb-6 flex items-center gap-3">
              <a 
                ...
                className="hover:text-brand-brightBlue transition-colors inline-flex items-center gap-3 text-white"
              >
                {t('about.name')}
                <Linkedin className="inline h-6 w-6" />
              </a>
            </h3>
            <p className={`text-gray-200 leading-relaxed text-lg ${i18n.language === 'en' ? 'text-left' : 'text-right'}`}>
              {t('about.description1')}
            </p>
            <p className={`text-gray-200 leading-relaxed text-lg mt-4 ${i18n.language === 'en' ? 'text-left' : 'text-right'}`}>
